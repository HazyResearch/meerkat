...
class SpacyColumn(AbstractColumn):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        super(SpacyColumn, self).__init__(num_rows=len(self), *args, **kwargs)
    ...
    def __getitem__(self, index):
        ...
        # TODO(karan): do we need collate in SpacyColumn
        # if self._materialize:  # self._collate
        #     # return a batch
        #     return self.collate([element for element in data])
        # else:
        #     # if not materializing, return a new SpacyColumn
    ...
    def batch(
        ...
        **kwargs,
        ...
        #     )
        # else:
        #     return super(SpacyColumn, self).batch(
    ...
    @classmethod
    def read(cls, path: str) -> SpacyColumn:
        # Load in the data
        metadata = dict(
            yaml.load(
