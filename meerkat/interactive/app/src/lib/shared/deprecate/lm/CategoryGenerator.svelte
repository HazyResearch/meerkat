...
import SchemaTree from "./SchemaTree.svelte";
    ...
    const dataset_description = field('dataset_description', undefined, [required()], {checkOnInit: true});
    ...
    let submit_form = async (e) => {
        ...
        if ($dataset_description.valid) {
            ...
            $stored_categorization.get($dataset_description.value).push(...category_generation_response.categories);
