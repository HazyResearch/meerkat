<script lang="ts">
	...
	interface BlockInterface {
		...
		base_datapanel_id: string;
	}

	function add_block(block_id: string, block_element: string, base_datapanel_id: string): void {
		blocks = [...blocks, { block_id, block_element, base_datapanel_id }];
