	...
	<div class="form-control">
		<div class="input-group w-100% flex items-center align-middle px-3 space-x-2">
			...
			<button 
				...
				<svg class="h-6 w-6" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 44.143 44.143" xml:space="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path style="fill:#030104;" d="M40.727,0.177H3.416V0.176C1.532,0.176,0,1.708,0,3.592V40.55c0,1.885,1.532,3.416,3.416,3.416 h37.311c1.885,0,3.416-1.531,3.416-3.416V3.593C44.143,1.709,42.612,0.177,40.727,0.177z M42.143,40.55 c0,0.781-0.635,1.416-1.416,1.416H3.416C2.635,41.966,2,41.332,2,40.55V3.592c0-0.781,0.635-1.416,1.416-1.416h37.311 c0.781-0.001,1.416,0.634,1.416,1.416V40.55z"></path> <path style="fill:#030104;" d="M34.738,21.073H9.404c-0.553,0-1,0.447-1,1s0.447,1,1,1h25.334c0.553,0,1-0.447,1-1 C35.738,21.519,35.291,21.073,34.738,21.073z"></path> </g> </g> </g></svg>
			</button>
			...
			<button 
				...
				<svg class="h-[22px] w-[22px] p-1" fill="#000000" viewBox="0 0 15 15" id="plus-16px" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path id="Path_60" data-name="Path 60" d="M14.5,55H8V48.5a.5.5,0,0,0-1,0V55H.5a.5.5,0,0,0,0,1H7v6.5a.5.5,0,0,0,1,0V56h6.5a.5.5,0,0,0,0-1Z" transform="translate(0 -48)"></path> </g></svg>
			</button>
			...
			<button 
				...
				<svg class="h-[22px] w-[22px] p-[2px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M22.719 12A10.719 10.719 0 0 1 1.28 12h.838a9.916 9.916 0 1 0 1.373-5H8v1H2V2h1v4.2A10.71 10.71 0 0 1 22.719 12z"></path><path fill="none" d="M0 0h24v24H0z"></path></g></svg>
			</button>


			<button class="btn btn-ghost btn-sm bg-violet-200 border border-black rounded-sm hover:bg-violet-300" on:click={
				() => {
					onSearch();
				}
			}>
				<svg class="h-[22px] w-[22px] p-[2px]" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M2.78 2L2 2.41v12l.78.42 9-6V8l-9-6zM3 13.48V3.35l7.6 5.07L3 13.48z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M6 14.683l8.78-5.853V8L6 2.147V3.35l7.6 5.07L6 13.48v1.203z"></path></g></svg>
			</button>
