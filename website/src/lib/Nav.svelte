...
>
	...
	<div class="flex flex-wrap my-1 sm:my-0 md:order-2">
		<a href="https://github.com/hazyresearch/meerkat" target="_blank" class="ml-4 mr-8 my-1 sm:my-0 self-center">
		...
		<!-- Add a Github Logo that when clicked goes to the repo. -->
